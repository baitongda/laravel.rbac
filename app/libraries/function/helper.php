...
function check_model($modelname){
    if(strtolower(getCurrentControllerName()) == $modelname){
        return 1;
    }
    return 0;
}
...
function get_cms_ads($str,$charset="utf-8"){
    return '<script type="text/javascript" src="'.config('admin.web_path').config('admin.web_adsensepath').'/'.$str.'.js" charset="utf-8"></script>';
}
// 获取标题颜色
...
function getCurrentControllerName() {
    return str_replace(['\\','Controller'],['',''],strrchr(getCurrentControllerClassName(),'\\'));
}
